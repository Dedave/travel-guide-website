  ...
  luggage: [
    {
      ...
      description:
        "Large-capacity travel backpack with external USB charging port, dedicated 15.6\" laptop compartment, and anti-theft back pocket. Fits most airline overhead bins.",
      price: "$38.99",
      rating: 4.8,
      reviews: 3241,
    ...
    {
      id: 2,
      name: "Polycarbonate Spinner Carry-On Suitcase",
      description:
        "Ultra-lightweight hardshell suitcase with 360° silent spinner wheels, TSA-approved combination lock, and expandable main compartment. 20-inch cabin size.",
      price: "$79.99",
      rating: 4.7,
      reviews: 2156,
    ...
    {
      id: 3,
      name: "Compression Packing Cubes Set (6pcs)",
      description:
        "Six-piece set of nylon compression packing organizers in XL, L, M, S, shoe bag, and laundry bag sizes. Double-zip compression squeezes 30% more into your bag.",
      price: "$22.99",
      rating: 4.9,
      reviews: 4812,
      image: "https://images.unsplash.com/photo-1581362071042-f0f3f0b4e3e6?w=800&h=600&fit=crop",
      affiliate: "aliexpress",
      badges: ["Top Rated", "Space Saver"],
    },
    {
      id: 4,
      name: "Hanging Waterproof Toiletry Bag",
      description:
        "Foldout hanging organizer with multiple transparent pockets, waterproof lining, and a sturdy hook. Keeps your bathroom essentials visible and accessible in any hotel.",
      price: "$16.99",
      rating: 4.6,
      reviews: 1243,
      image: "https://images.unsplash.com/photo-1585916420730-d7f95e942d43?w=800&h=600&fit=crop",
      affiliate: "shein",
      badges: ["Waterproof", "Hanging Hook"],
    },
  ],
  clothing: [
    {
      id: 5,
      name: "Lightweight Quick-Dry Cargo Pants",
      description:
        "Stretchy, fast-drying travel pants with multiple zip pockets including a hidden security pocket. Elastic waistband and slim-fit cut work for hiking or city days.",
      price: "$28.99",
      rating: 4.5,
      reviews: 1876,
      image: "https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=800&h=600&fit=crop",
      affiliate: "shein",
      badges: ["Quick Dry", "Zip Pockets"],
    },
    {
      id: 6,
      name: "Packable Hooded Rain Jacket",
      description:
        "Waterproof windbreaker that stuffs into its own front pocket. Sealed seams, adjustable hood and cuffs, and weighs under 280g — takes up no room in your bag.",
      price: "$34.99",
      rating: 4.7,
      reviews: 2034,
    ...
    {
      id: 7,
      name: "Moisture-Wicking Travel T-Shirt",
      description:
        "Lightweight polyester-blend tee with odor-resistant finish and four-way stretch. Dries in under two hours — perfect for hand-washing on the road.",
      price: "$18.99",
      rating: 4.6,
      reviews: 987,
      image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&h=600&fit=crop",
      affiliate: "shein",
      badges: ["Odor Control", "Fast Dry"],
    },
    {
      id: 8,
      name: "Infinity Travel Scarf with Hidden Pocket",
      description:
        "Stylish loop scarf with a discreet internal zipper pocket sized for cards, cash, and a folded note. Lightweight enough to double as a plane blanket.",
      price: "$14.99",
      rating: 4.5,
      reviews: 763,
      image: "https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=800&h=600&fit=crop",
      affiliate: "shein",
      badges: ["Hidden Pocket", "Dual-Use"],
    },
  ],
  tech: [
    {
      ...
      description:
        "All-in-one plug adapter covering 50+ countries with 3 USB-A ports, 1 USB-C PD 20W port, and surge protection. Compact cube design fits in any pocket.",
      price: "$24.99",
      rating: 4.9,
      reviews: 5634,
      image: "https://images.unsplash.com/photo-1591290619762-d6b8f0529c81?w=800&h=600&fit=crop",
      affiliate: "aliexpress",
    ...
    },
    {
      ...
      description:
        "High-capacity power bank with 22.5W fast charging, dual USB-A and USB-C outputs, and LED battery display. Airline-approved and charges a phone 5+ times.",
      price: "$32.99",
      rating: 4.7,
      reviews: 4102,
    ...
    {
      id: 11,
      name: "Wireless ANC Earbuds with Travel Case",
      description:
        "Active noise-cancelling earbuds with 8-hour playback per charge (30 hours total with case), transparency mode, and a slim case built for travel.",
      price: "$45.99",
      rating: 4.6,
      reviews: 2891,
    ...
    {
      id: 12,
      name: "Flexible Tripod with Bluetooth Remote",
      description:
        "Bendable mini tripod that wraps around poles, railings, or stands solo on any surface. Comes with a wireless Bluetooth shutter for solo travel photography.",
      price: "$13.99",
      rating: 4.5,
      reviews: 2267,
      image: "https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=800&h=600&fit=crop",
      affiliate: "aliexpress",
      badges: ["Flexible", "Bluetooth Remote"],
    },
  ],
  accessories: [
    {
      id: 13,
      name: "Memory Foam Neck Pillow with Hood",
      description:
        "Ergonomic U-shaped memory foam pillow with a built-in privacy hood and machine-washable cover. The hood blocks light and reclines to a flat position when not in use.",
      price: "$27.99",
      rating: 4.8,
      reviews: 3156,
      image: "https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?w=800&h=600&fit=crop",
      affiliate: "aliexpress",
      badges: ["Memory Foam", "Privacy Hood"],
    },
    {
      id: 14,
      name: "RFID-Blocking Passport Holder Wallet",
      description:
        "Slim travel wallet with RFID-blocking lining to protect card data. Fits a passport, up to 6 cards, a boarding pass, and foreign currency. Available in 10 colours.",
      price: "$12.99",
      rating: 4.7,
      reviews: 2089,
      image: "https://images.unsplash.com/photo-1578328819058-b69f3a3b0f6b?w=800&h=600&fit=crop",
      affiliate: "shein",
      badges: ["RFID Protection", "Multi-Slot"],
    },
    {
      id: 15,
      name: "Collapsible Water Bottle with Filter",
      description:
        "600ml silicone bottle that folds flat when empty. Integrated carbon filter removes chlorine and odours so you can safely refill from hotel taps worldwide.",
      price: "$19.99",
      rating: 4.6,
      reviews: 1734,
      image: "https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=800&h=600&fit=crop",
      affiliate: "aliexpress",
      badges: ["Eco-Friendly", "Built-in Filter"],
    },
    {
      id: 16,
      name: "Quick-Dry Microfiber Towel Set (3 Sizes)",
      description:
        "Bath, hand, and face towels in one compact roll bag. Absorbs 4× their weight in water and dry within 30 minutes. Essential for hostels, beaches, and camping.",
      price: "$18.99",
      rating: 4.8,
      reviews: 2901,
      image: "https://images.unsplash.com/photo-1585855903916-77c8be5b3e60?w=800&h=600&fit=crop",
      affiliate: "shein",
      badges: ["Quick Dry", "3-Pack"],
    },
  ],
};
