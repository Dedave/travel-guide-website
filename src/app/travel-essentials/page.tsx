...
const products = {
  luggage: [
    ...
    { id: 5,  name: "TSA-Approved Luggage Locks (2-Pack)",     description: "Zinc alloy combination locks recognized by TSA inspectors worldwide. Resettable 3-digit code, hardened steel shackle, and fits all standard luggage zippers.",                            price: "$11.99", rating: 4.7, reviews: 3890, image: "https://images.unsplash.com/photo-1544966503-7cc5ac882d5f?w=800&h=600&fit=crop",       affiliate: "aliexpress", badges: ["TSA Approved", "2-Pack"] },
    { id: 6,  name: "Portable Digital Luggage Scale",          description: "Weighs up to 50kg with 10g precision. LCD backlit display, auto-off after 60 seconds, and a soft grip handle. Never pay overweight fees again — weighs your bag before you leave.",           price: "$9.99",  rating: 4.8, reviews: 5123, image: "https://images.unsplash.com/photo-1586495985104-901b0c6572f8?w=800&h=600&fit=crop",       affiliate: "aliexpress", badges: ["50kg Capacity", "Compact"] },
  ...
  accessories: [
    ...
    { id: 24, name: "Quick-Dry Microfiber Towel Set (3 Sizes)", description: "Bath, hand, and face towels packed in one compact roll bag. Absorbs 4× their weight in water and dries in 30 minutes. A hostel, beach, and camping essential.",                           price: "$18.99", rating: 4.8, reviews: 2901, image: "https://images.unsplash.com/photo-1585855903916-77c8be5b3e60?w=800&h=600&fit=crop",       affiliate: "shein",      badges: ["Quick Dry", "3 Sizes"] },
  ...
  sleep: [
    ...
    { id: 38, name: "Silk Sleep Sack Liner",                   description: "100% mulberry silk sleeping bag liner that slides into a hostel duvet cover or sleeping bag. Silky against skin, temperature regulating, and weighs 140g. Washable and packs to the size of a sock.", price: "$34.99", rating: 4.8, reviews: 1234, image: "https://images.unsplash.com/photo-1585855903916-77c8be5b3e60?w=800&h=600&fit=crop",       affiliate: "shein",      badges: ["100% Silk", "140g"] },
      ...
      <section className="relative overflow-hidden bg-gray-950 min-h-[540px] flex items-end">
        <div className="absolute inset-0 grid grid-cols-4 opacity-[0.22] pointer-events-none">
          {[
            ...
            "https://images.unsplash.com/photo-1591290619762-d6b8f0529c81?w=400&h=700&fit=crop",
