    ...
    items: [
      {
        ...
        logo: "✈",
        // Fixed: was /flights/ — correct deep-link is /flights-to/
        url: (dest: string) =>
          dest
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        logo: "🌏",
        // Fixed: added partner ID cid=1962595
        url: (dest: string) =>
    ...
    items: [
      {
        ...
        logo: "🛡",
        // Fixed: added /nomad-insurance/ path
        url: () =>
    ...
    items: [
      {
        ...
        logo: "📱",
        // Fixed: was generic search URL — now uses affiliate deep link
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-400 font-body text-lg max-w-xl mx-auto leading-relaxed">
            We partner with the world's best travel platforms so you get the lowest prices,
            best coverage, and seamless booking — all in one place.
          </p>
          ...
          {affiliates.map((section) => {
            ...
            return (
              <div
                ...
                className="group bg-white/5 border border-white/8 rounded-3xl overflow-hidden
                  hover:border-white/15 hover:bg-white/8 transition-all duration-300"
              >
                {/* Card header */}
                ...
                <div className="p-4 space-y-3">
                  {section.items.map((item) => (
                    <a
                      ...
                      className="flex items-center gap-3 bg-white/5 hover:bg-white/10 border border-white/8
                        hover:border-white/15 rounded-2xl p-4 transition-all duration-200 group/item"
                    >
                      <div className="text-2xl shrink-0">{item.logo}</div>
                      <div className="flex-1 min-w-0">
                        <div className="text-white font-bold text-sm font-body mb-0.5">{item.name}</div>
                      ...
                      <div className="shrink-0">
                        <div className="inline-flex items-center gap-1 bg-white text-gray-900 font-bold font-body
                          text-[10px] px-3 py-1.5 rounded-full group-hover/item:bg-yellow-400 transition-all whitespace-nowrap">
                          {item.cta}
        ...
        <p className="text-center text-gray-700 text-[11px] font-body mt-8 leading-relaxed max-w-2xl mx-auto">
          <span className="font-bold text-gray-600">Affiliate disclosure:</span> Some links above
          are affiliate links. When you book through them, we may earn a small commission at no
          extra cost to you. This helps keep our guides free and updated. We only recommend
